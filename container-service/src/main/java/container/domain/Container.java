...
public class Container extends PanacheEntity
{
    ...
    public Container(String voyageID, String shipID, String originPort, String destinationPort, String plannedDepartureDate,
    ...
    {
        this.voyageID = container.getVoyageID();
	}
